...
namespace SKD.Effects
{
    ...
    public class TakeBlockedDamageEffect : InstantCharacterEffect
    {
        ...
        private void CalculateDamage(CharacterManager characterManager)
        {
            ...
            _physicalDamage -=( _physicalDamage * (characterManager._characterStatsManager._blockingPhysicalAbsorption / 100));
            ...
            _lightingDamage -= _lightingDamage * (characterManager._characterStatsManager._blockingLightningAbsorption / 100);
        ...
        private void PlayDirectionBasedBlockingAnimation(CharacterManager character)
        {
            ...
            DamageIntensity damageIntensity = WorldUtilityManager.Instance.GetDamageIntensityBasedOnPoiseDamage(_poiseDamage);
